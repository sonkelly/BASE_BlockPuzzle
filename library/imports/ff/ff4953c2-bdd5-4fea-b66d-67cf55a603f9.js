"use strict";
cc._RF.push(module, 'ff495PCvdVP6rZtZ89VpgP5', 'LvData_JieMi');
// Scripts/LvData_JieMi.ts
...
var LvData_JieMi = /** @class */ (function () {
    function LvData_JieMi() {
    }
    LvData_JieMi.JM_LEVEL_DATA = {
        1: {
    ...
    LvData_JieMi = __decorate([
        ccclass
    ], LvData_JieMi);
    return LvData_JieMi;
}());
exports.default = LvData_JieMi;
